  ...
  if (card.isJoker) {
    return (
      <div onClick={!disabled ? onClick : undefined} style={{
        width: w, height: h, borderRadius: 7,
        background: selected ? 'linear-gradient(135deg, #fffbe6, #fff3cc)' : 'linear-gradient(160deg, #fff 0%, #f5f5f5 100%)',
        border: selected ? '2.5px solid #f0c040' : '1.5px solid rgba(0,0,0,0.15)',
        boxShadow: selected ? '0 0 0 2px rgba(240,192,64,0.4), 0 8px 20px rgba(0,0,0,0.4)' : '2px 4px 10px rgba(0,0,0,0.3)',
